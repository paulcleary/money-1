...
public interface Span {
     ...
     */
    Span startTimer(String timerKey);
     ...
     */
    Span stopTimer(String timerKey);

    /**
      * @return a map of all of the notes that were recorded on the span
     */
    ...
    /**
     * @return how long since the span was started
     */
    Long duration();
